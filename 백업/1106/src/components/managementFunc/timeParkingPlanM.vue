            ...
            <!--   <dd>
              ...
              /><span>원</span></label>                                   
                ...
                <input type="text" :disabled="def.count == 'infinite'"  onKeyup="this.value=this.value.replace(/[^0-9]/g,'');"><span>회</span>
                  ...
                  <label><input type="text" v-model="current.std_price"  /><span>원</span></label>                                   
                ...
                <label> <input type="text" v-model="current.add1_price" /><span>원</span></label>
                ...
                <label> <input type="text" id="addPrice" v-model="current.add2_price" /><span>원</span></label>
                ...
                <label> <input type="text" id="addPrice" v-model="current.add3_price" /><span>원</span></label>
