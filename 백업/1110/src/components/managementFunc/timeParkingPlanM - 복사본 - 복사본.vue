          ...
          <div class="form_window">
            <form>
              ...
              <dl class="step_price">
                ...
                /><span>원</span></label>                                   
                  ...
                  <dd>
                    ...
                    <label><input type="radio" value="infinite" v-model="add.countCheck" /><span>무한</span></label>
                    <label><input type="radio" value="count" v-model="add.countCheck" /><span>횟수</span>
                    <input type="text" :disabled="add.countCheck == 'infinite'"  onKeyup="this.value=this.value.replace(/[^0-9]/g,'');"
                  ...
                  <dd v-show="textShow" class="dayContentsWrap">
                    ...
                    <label><input type="radio" value="infinite" v-model="add2.countCheck" /><span>무한</span></label>
                    <label><input type="radio" value="count" v-model="add2.countCheck" /><span>횟수</span>
                    <input type="text" :disabled="add2.countCheck == 'infinite'"  onKeyup="this.value=this.value.replace(/[^0-9]/g,'');"
                  ...
                  <dd v-show="textShow2" class="dayContentsWrap">
                    ...
                    <label><input type="radio" value="infinite" v-model="add3.countCheck" /><span>무한</span></label>
                    <label><input type="radio" value="count" v-model="add3.countCheck" /><span>횟수</span>
                    <input type="text" :disabled="add3.countCheck == 'infinite'"  onKeyup="this.value=this.value.replace(/[^0-9]/g,'');"
                  ...
                  <dd v-show="textShow3" class="dayContentsWrap">
                    ...
                    <label><input type="radio" value="infinite" v-model="add4.countCheck" /><span>무한</span></label>
                    <label><input type="radio" value="count" v-model="add4.countCheck" /><span>횟수</span>
                    <input type="text" :disabled="add4.countCheck == 'infinite'"  onKeyup="this.value=this.value.replace(/[^0-9]/g,'');"
                  ...
                  <dd v-show="textShow4" class="dayContentsWrap">
                    ...
                    <label><input type="radio" value="infinite" v-model="add5.countCheck" /><span>무한</span></label>
                    <label><input type="radio" value="count" v-model="add5.countCheck" /><span>횟수</span>
                    <input type="text" :disabled="add5.countCheck == 'infinite'"  onKeyup="this.value=this.value.replace(/[^0-9]/g,'');"
              ...
              <dl class="maxPrice">
                <dt>최대요금</dt>
                <dd>                   
                  <label>일일 최대 요금{{amt}} <input type="checkbox" v-model="maxPay.limit" :checked="maxPay.limit" /><span>무한</span></label>
                  <input type="text" v-model="maxPay.check" :disabled="maxPay.limit === true"  @input="comma()"/><span>원</span></dd>
                <dd>
                <dd>
                  <label>일일 최대 요금<input type="checkbox" v-model="maxPay2.limit" :checked="maxPay2.limit" /><span>무한</span></label>
