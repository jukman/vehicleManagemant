...
<div class="report_wrap">
    ...
    <div>
      <div class="form_window parkingInfo">
        <form>
           <div class="modify_bt">
          <button @click.prevent="modifyVehicle1" class="modifybtn">
             <font-awesome-icon icon="tools" />수정
          </button>      
          </div>
          <dl>
            <dt>1. 기본 정보</dt>
            <dd>주차장명 : <input  type="text"   v-model="basic_info.parking_name" /></dd>
            <dd>주차장 전화번호 : <input type="text"  v-model="basic_info.parking_phone" /></dd>
            <dd>주차장 주소 : <input type="text" v-model="basic_info.parking_address" /></dd>
            <dd>주차장 GPS 경도 : <input type="text"  v-model="basic_info.parking_gps_lat" /></dd>
            <dd>주차장GPS 위도 : <input type="text" v-model="basic_info.parking_gps_lng" /></dd>
            <dd>주차장 운영상태 : <input type="text" v-model="basic_info.parking_run_state" /></dd>
          </dl> 
          <dl>
            <dt>2. 사업자 정보</dt>
            <dd>주차사업자명 : <input  type="text"   v-model="company_info.company_name" /></dd>
            <dd>사업자등록번호 : <input type="text"  v-model="company_info.company_registration_number" /></dd>
            <dd><span>사업자 법인등록번호 :</span><input type="text" v-model="company_info.company_corporation_number" /></dd>
            <dd><span>사업자 주소 :</span><input type="text"  v-model="company_info.company_address" /></dd>
          </dl>
          <dl class="operating_time">
            <dt>3. 운영시간</dt>
            <dd>월요일 : <input  type="text"  v-model="operation_time.mon.start_time" /> ~
                       <input  type="text"  v-model="operation_time.mon.end_time" /></dd> 
             <dd>화요일 : <input  type="text"  v-model="operation_time.tue.start_time" /> ~
                       <input  type="text"  v-model="operation_time.tue.end_time" /></dd> 
             <dd>수요일 : <input  type="text"  v-model="operation_time.wed.start_time" /> ~
                       <input  type="text"  v-model="operation_time.wed.end_time" /></dd> 
             <dd>목요일 : <input  type="text"  v-model="operation_time.thu.start_time" /> ~
                       <input  type="text"  v-model="operation_time.thu.end_time" /></dd> 
             <dd>금요일 : <input  type="text"  v-model="operation_time.fri.start_time" /> ~
                       <input  type="text"  v-model="operation_time.fri.end_time" /></dd> 
             <dd>토요일 : <input  type="text"  v-model="operation_time.sat.start_time" /> ~
                       <input  type="text"  v-model="operation_time.sat.end_time" /></dd> 
             <dd>일요일 : <input  type="text"  v-model="operation_time.sun.start_time" /> ~
                       <input  type="text"  v-model="operation_time.sun.end_time" /></dd> 
             <dd>법정공휴일 : <input  type="text"  v-model="operation_time.legal_holidays.start_time" /> ~
                       <input  type="text"  v-model="operation_time.legal_holidays.end_time" /></dd> 
          </dl>
          <dl>
            <dt>4. 할인순서</dt>
            <dd>1순위 : <input  type="text"  v-model="procedure.first" /></dd> 
            <dd>2순위 : <input  type="text"  v-model="procedure.second" /></dd> 
            <dd>3순위 : <input  type="text"  v-model="procedure.third" /></dd>   
          </dl>     
          <dl>
            <dt>5. 요금관리</dt>
            <dd>무료주차시간(회차)(분) : <input  type="text"  v-model="price_manage.service_time" /></dd> 
            <dd>그래이스시간(분) : <input  type="text"  v-model="price_manage.grace_time" /></dd> 
            <dd>정산후여유시간(분) : <input  type="text"  v-model="price_manage.lagtime" /></dd>   
          </dl>   
          <dl>
            <dt>6. 요금제</dt>
          </dl>   
