...
<div class="report_wrap">
   <!-- 등록팝업 -->
    <div class="resist_pop popup tenant" v-show="resistIs">
        <div>
          <h3>{{mainTitle[0].subMenu[11].title}} 등록</h3>
          ...
          <div class="form_window">
            <form>
              ...
              <dl>
                <dt>패스워드</dt>
                <dd><input type="password" id="start_time" v-model="reg.startTime" /></dd>
              </dl>
              <dl>
                <dt>입주사명</dt>
              ...
              <dl>
                <dt>이름</dt>
                <dd><input type="text" id="end_time" v-model="reg.endTime" /></dd>
              </dl>
              <dl>
                <dt>연락처</dt>
