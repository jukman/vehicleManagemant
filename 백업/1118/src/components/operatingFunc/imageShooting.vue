...
export default {
  data: function() {
   return {
      vehiclePicture: [],
      image_name: "http://ht1.iptime.org:3000/images/2020_11_17/1605598824295.jpg",
      imageTitle: ""
    }
  }, 
  computed: {
  ...
  methods: {
     submitForm() {
      ...
      frm.setAttribute('action', 'http://ht1.iptime.org:3000/images/2020_11_18/1605656947856.jpg')
    ...
    image_capture(c) {
      this.vehiclePicture.forEach(imgShow => {       
        if (imgShow.active === true) {
          // this.imageTitle = imgShow.location + "_" + imgShow.direction + imgShow.type
