    ...
    <div class="record_wrap">
      <div class="menu_title">
        <div class="counting">
          ...
          <span><font-awesome-icon icon="sign-out-alt" />출차수:{{
              count_out
            }}건</span>
          <span><font-awesome-icon icon="sign-in-alt" />입차수:{{
              count_in
            }}건</span>
        </div>
      </div>
            ...
            <tr v-for="(d, index) in dataList" :key="index">
              <td colspan="11">
                <table>
                  ...
                  <tr v-if="d.get_image_display === false">
...
export default {
  data: function() {
    return {
      dataList: [{get_time:"준비중",get_location:"준비중",get_direction:"준비중",get_lp:"준비중",get_fee:"준비중",get_discounted_fee:"준비중",get_paid_fee:"준비중",get_registered:"준비중",get_contents:"준비중"}],
      carmera_list: [   {
