          ...
          <div class="form_window">
            <form>
              ...
              <dl class="maxPrice">
                <dt>최대요금</dt>
                <dd>
                  <label>일일 최대 요금<input type="checkbox" value="every" v-model="maxPay.limit1" /><span>무한</span></label>
                  <input type="text" v-model="maxPay.everyDay" /><span>원</span></dd>
                <dd>
                  <label>절대 최대 요금<input type="checkbox" value="never" v-model="maxPay.limit2" /><span>무한</span></label>
