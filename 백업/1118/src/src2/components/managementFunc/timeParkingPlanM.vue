          ...
          <form>
            ...
            <dl class="step_price">
              <dt>단계별 요금</dt>            
                ...
                <label><input type="radio" value="count" v-model="reg.add2_count_check" /><span>횟수</span>
                ...
                <label><input type="radio" value="count" v-model="reg.add3_count_check" /><span>횟수</span>
            ...
            <dl class="step_price">
              ...
              <dd>
                <h6>일일 최대 요금</h6>                   
                <label><input type="checkbox" v-model="reg.maximum_fee_check" /><span>무한</span></label>
                <input type="text" v-model="reg.maximum_fee" class="won" /><span>원</span></dd>             
              <dd>
                <h6>절대 최대 요금</h6>
                <label><input type="checkbox" v-model="reg.abs_maximum_fee_check" /><span>무한</span></label>
                <input type="text" v-model="reg.abs_maximum_fee" class="won" /><span>원</span></dd>               
          ...
          <form>
            ...
            <dl class="step_price">
              <dt>단계별 요금</dt>
                ...
                <label><input type="radio" value="count" v-model="current.add2_count_check" /><span>횟수</span>
                <input type="text" v-model="current.add2_count"/><span>회</span>
                </label>
                </dd>  
                <dd>
                   <h6>추가요금3</h6>
                ...
                <label><input type="radio" value="count" v-model="current.add3_count_check" /><span>횟수</span>
                <input type="text" v-model="current.add3_count"/><span>회</span>
                </label>
                </dd>                    
            </dl>
            <dl class="step_price">
              ...
              <dd>
                <h6>일일 최대 요금</h6>                   
                <label><input type="checkbox" v-model="current.maximum_fee_check" /><span>무한</span></label>
                <input type="text" v-model="current.maximum_fee" class="won" /><span>원</span></dd>
              <dd>
                <h6>절대 최대 요금</h6>
                <label><input type="checkbox" v-model="current.abs_maximum_fee_check" /><span>무한</span></label>
                <input type="text" v-model="current.abs_maximum_fee" class="won"/><span>원</span></dd>                             
            </dl>
            <div class="btns">            
