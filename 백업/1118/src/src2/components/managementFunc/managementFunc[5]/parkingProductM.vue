...
<div class="report_wrap">
    <div class="title">
      <h2>{{mainTitle[0].subMenu[12].title}}</h2>
    </div>
    ...
    <div class="resist_pop popup" v-show="resistIs">
      <div>
        <h3>{{mainTitle[0].subMenu[12].title}} 등록</h3>
        ...
        <div class="form_window">
          <form>
           ...
           <dl>
              <dd>상품명: <input type="text"  v-model="r.parking_product_name" /></dd>
           </dl>
            <dl>              
              <dd>분류1:
            ...
            <dl>            
                <dd>정상가격: <input type="text" v-model="r.normal_price" /></dd>
            </dl> 
            <dl>            
                <dd>주차요금: <input type="text" v-model="r.parking_price" /></dd>
            </dl>
            <dl>            
                <dd>비고: <input type="text" v-model="r.contents" /></dd>
            </dl>            
     ...
     <div class="modify_pop popup" v-show="modifyIs">
      <div>
       ...
       <div class="form_window">
           ...
           <dl>
              <dd>상품명: <input type="text"  v-model="m.parking_product_name" /></dd>
           </dl>
            <dl>              
              <dd>분류1:
            ...
            <dl>            
                <dd>정상가격: <input type="text" v-model="m.normal_price" /></dd>
            </dl> 
            <dl>            
                <dd>주차요금: <input type="text" v-model="m.parking_price" /></dd>
            </dl>            
            <dl>            
                <dd>비고: <input type="text" v-model="m.contents" /></dd>
            </dl>            
          </form>         
